(function() {
	...
	function W(a, b, c) {
		b.href && (a = T(a, b.href, void 0 === c ? !1 : c), q.test(a) && (b.href = a))
	}
	...
	var X = function(a) {
			try {
				...
				if(c) {
					var d = c.protocol;
					"http:" !== d && "https:" !== d || U(c, c.hostname, !1)
				}
			}
			catch(e) {}
		},
	...
	l("google_tag_data.glBridge.decorate", function(a, b, c) {
		...
		a = O(a);
		if(b.tagName) {
			if("a" == b.tagName.toLowerCase()) return W(a, b, c);
			if("form" == b.tagName.toLowerCase()) return V(a, b)
		}
...
(function() {
	...
	var ad = void 0,
		...
		ge = function(a, b, c) {
			1 <=
				100 * Math.random() || G("?") || (a = ["t=error", "_e=" + a, "_v=j76", "sr=1"], b && a.push("_f=" + b), c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + hd()), wc(ad ? ad + "/33" : bd(!0) + "/u/d", a.join("&"), ua))
		};
	var h = function(a) {
